...
struct Words {
    ...
    static let entries: [String: [String]] = [
        ...
        "recordPaused":["Grabación pausada por ti","Recording paused by you"],
        "recordInterrupted":["Grabación interrumpida por el sistema","Recording interrupted by the system"],
        "recordRecovered":["Sesión recuperada · micrófono detenido","Session recovered · microphone stopped"],
        "recordRoute":["Entrada de audio cambiada · grabación pausada","Audio input changed · recording paused"],
        "recordReset":["Audio reiniciado por iOS · pulsa Reanudar","iOS reset audio · tap Resume"],
        "recordDenied":["Micrófono sin permiso","Microphone permission is off"],
        "recordError":["Grabación detenida por un error","Recording stopped after an error"],
        "recordAlarm":["Micrófono detenido para la alarma","Microphone stopped for the alarm"],
        "recordFailure":["No se ha podido guardar o continuar la grabación.","Could not save or continue recording."],
        "pauseCapture":["Pausar micrófono","Pause microphone"], "resumeCapture":["Reanudar micrófono","Resume microphone"],
        "enableCapture":["Activar micrófono","Enable microphone"],
        "recordLimits":["Puede continuar con la pantalla bloqueada. Al cerrar la app a la fuerza, se detiene; al volver, pulsa Reanudar. Las llamadas pueden interrumpirla.","Can continue with the screen locked. Force-quitting stops it; tap Resume after reopening. Calls may interrupt it."],
        "captureTime":["Audio observado","Audio observed"], "captureGaps":["Los huecos son tiempo sin captura de audio.","Gaps are periods without captured audio."],
        "sensitivity":["Sensibilidad al ruido","Noise sensitivity"], "sensitive":["Alta · sonidos suaves","High · quieter sounds"], "normalSensitivity":["Normal","Normal"], "lessSensitive":["Baja · habitación ruidosa","Low · noisy room"],
        ...
        "recordHint":["Con tu permiso, el micrófono detecta cambios de sonido sobre el ruido de fondo. Guarda eventos con hasta 2 segundos de contexto antes y después, en partes de hasta 30 segundos. Solo se almacenan en este iPhone.","With your permission, the microphone detects changes above background noise. Events include up to 2 seconds before and after, in parts of up to 30 seconds. They stay on this iPhone."],
